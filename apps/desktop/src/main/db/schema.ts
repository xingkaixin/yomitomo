...
export const articles = sqliteTable(
  'articles',
  {
    ...
    readingDeliberationProviderId: text('reading_deliberation_provider_id'),
    readingDeliberationProviderName: text('reading_deliberation_provider_name'),
    readingDeliberationModelName: text('reading_deliberation_model_name'),
    readingDeliberationCreatedAt: text('reading_deliberation_created_at'),
    readingDeliberationUpdatedAt: text('reading_deliberation_updated_at'),
    ...
    readingCardReviewId: text('reading_card_review_id'),
