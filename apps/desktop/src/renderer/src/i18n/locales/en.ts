...
export const enResources = {
  app: {
    ...
    readingEvidence: {
      assetTypes: { annotation: 'Highlight', comment: 'Discussion', distillation: 'Distillation' },
      authors: {
        user: 'My judgment',
        ai: 'Assistant discussion',
        aiAssisted: 'AI-assisted distillation',
        source: 'Source evidence',
      },
      relations: { same: 'Same', complementary: 'Complementary', opposite: 'Opposite' },
      excerpt: 'Original excerpt',
      openSource: 'Back to source',
      openDiscussion: 'View discussion',
      locationUnavailable: 'Could not locate the original text. The saved excerpt is retained.',
      sourceUnavailable: 'This source is no longer available.',
    },
    readingMemory: {
      title: 'Reading memory',
      tabs: {
        label: 'Reading memory views',
      ...
      library: {
        ...
        chooseCollection: 'Choose a collection to ask.',
        ...
        actualCollection: 'Collection: {{name}}',
        counts: '{{sources}} sources · {{judgments}} saved judgments',
        emptyScope: 'This scope has no reading sources yet.',
        sparse:
          'This scope has fewer than 2 sources or 5 saved judgments. Save thoughts worth keeping as you read, publish a distillation, or choose a scope with more existing judgments. Nothing outside this scope will be added.',
        contextLoading: 'Checking this scope and destination…',
        contextFailed: 'Could not check this scope. Retry before asking.',
        ...
        confirmPrivacy: 'Understand and answer this question',
        answerWith: 'Answer with {{provider}} · {{model}}',
        retryAnswer: 'Retry answer',
        receipt: 'What was sent',
        submittedQuestion: 'Submitted question',
        sourcePicker: {
          title: 'Choose sources',
          description:
            'Search annotations, discussions, and published distillations in the selected sources. Collections are unchanged.',
          searchLabel: 'Search sources',
          searchPlaceholder: 'Search by title or author',
          available: 'Available sources',
          selectedCount: 'Selected: {{count}}',
          emptySelection: 'Your selection stays when you search or change pages.',
          remove: 'Remove “{{title}}”',
          confirm: 'Use selected sources',
          noResults: 'No matching sources',
          limitReached: 'Select up to {{count}} sources.',
          retry: 'Retry',
        },
        answer: {
          judgments: 'Earlier judgments',
          supporting: 'Supporting evidence',
          opposingOrLimiting: 'Opposing evidence and limits',
          gaps: 'Evidence gaps',
          emptySection: 'The current evidence does not support a conclusion here.',
          citations: 'View {{count}} citations',
          saveThought: 'Save as thought',
        },
        thought: {
          title: 'Save as thought',
          description:
            'Choose one cited source. This opens a draft in its discussion editor; nothing is saved until you confirm there.',
          citations: 'Choose a citation',
          openDraft: 'Open draft',
          opening: 'Opening draft…',
          openFailed: 'Could not open the draft. The answer is unchanged; try again.',
          invalidEvidence: 'The cited evidence is no longer available. Ask again before saving.',
          draftBusy:
            'A thought is already being edited or saved. This draft was not loaded. Finish it, then return to Ask Library and try again.',
          draftLoadFailed: 'The draft could not be loaded. Return to Ask Library and try again.',
        },
      },
      ...
      providerChanged:
        'The provider, model, or endpoint changed. No model judgment is shown. Review the destination before trying again.',
      inputTooLarge:
        'The selection or question cannot fit within the input budget. Shorten it and try again.',
      evidenceChanged: 'The evidence changed or was deleted. Search again.',
      inputTruncated: 'Some evidence or context was shortened to limit what leaves this device.',
      sentEvidence: '{{count}} evidence items sent',
      privacy: {
        title: 'Before using remote reading memory',
        content:
          'Local search sends no reading content. Comparing relations sends only the selection, optional question, limited paragraph context, and up to 3 evidence items. Library questions use up to 12 items; review comparisons use up to 6. Every request has an input budget.',
        excluded:
          'Source titles, collection names, local asset identifiers, whole articles, whole books, and complete discussions are excluded. Model output is advice; it never changes or saves your judgments automatically.',
        control:
          'Your configured provider will process this content. This confirmation records your understanding, not permission for automatic requests. Each remote call still requires your action. Closing the panel clears the session.',
        recipient: 'Provider: {{provider}} · Model: {{model}}',
        stayLocal: 'Keep evidence local',
        confirm: 'Understand and compare this selection',
      },
      relations: {
        title: 'Related reading',
        description: 'Find past judgments in your highlights, thoughts, and distillations.',
        close: 'Close related reading',
        question: 'Add a question (optional)',
        questionPlaceholder: 'For example: did I previously see this differently?',
        search: 'Search again',
        searching: 'Finding related evidence on this device…',
        searchFailed:
          'Local search could not finish. Retry; reading and saved assets are unaffected.',
        empty:
          'No related past judgments were found. This searches saved reading assets, not entire books.',
        judgeWith: 'Compare with {{provider}} · {{model}}',
        judging: 'Comparing relations; cancel at any time',
        abstained: 'The evidence is insufficient to determine a relation. No labels were added.',
      },
    },
    readerUi: {
    ...
    updateDialog: {
      ...
      readyLead:
        'The update has finished downloading. Restart now, or install automatically when you quit later.',
      ...
      progressDetails: '{{transferred}} / {{total}} · {{speed}}/s',
      progressDetailsWaitingSpeed: '{{transferred}} / {{total}} · Calculating speed',
      progressAria: 'Update download {{percent}} percent, {{details}}',
    },
    about: {
    ...
    distillationLibrary: {
      ...
      clearSearch: 'Clear search',
      loading: 'Loading distillations',
      resultCount: '{{count}} distillations found',
      emptyTitle: 'No published distillations yet',
      emptyDescription: 'Finish and publish a distillation from an annotation to see it here.',
      noResultsTitle: 'No results for “{{query}}”',
      noResultsDescription: 'Try a shorter keyword or a different phrase.',
      loadFailed: 'Distillations could not be loaded',
      loadFailedDescription: 'Your local data is safe. Please try again.',
      refreshFailed: 'Refresh failed. Showing the previous results.',
      retry: 'Retry',
      originalText: 'Original text',
      openOriginal: 'Open annotation',
      pagination: 'Distillation pages',
    ...
    library: {
      ...
      sourceDescriptions: {
        ...
        ebook: 'Locally imported EPUB, AZW3, and MOBI ebooks.',
        pdf: 'Locally imported PDF documents.',
        text: 'Locally imported or pasted plain text and Markdown.',
      ...
      collection: {
        ...
        renameTitle: 'Edit collection name',
        renameDescription: 'The name appears in the library list and collection view.',
        delete: 'Delete collection',
        deleteConfirmTitle: 'Delete “{{name}}”?',
        deleteConfirmDescription:
          'This only deletes the collection and its membership. It does not delete the articles or WeRead items inside.',
        deleteConfirm: 'Delete collection',
        open: 'Open collection: {{name}}',
        back: 'Back to all',
        addMembers: 'Add to this collection',
        addExisting: 'Add existing items',
        removeMember: 'Remove from collection',
        nameLabel: 'Collection name',
        namePlaceholder: 'For example: System design',
        ...
        pickerDescription: 'Add to “{{name}}”',
        closePicker: 'Close collection picker',
        pickerSearchPlaceholder: 'Search articles, ebooks, PDFs, or WeRead...',
        pickerSearchLabel: 'Search items that can be added to the collection',
        pickerNoItems: 'No items can be added',
        selected: 'Selected',
        ...
        renamedToast: 'Collection name updated',
      ...
      import: {
        ...
        text: {
          ...
          asMarkdown: 'Parse as Markdown',
          dropTitle: 'Click to choose or drop files',
          dropHint: '.txt and .md supported, multiple allowed',
          filesSelected: '{{count}} file(s) selected',
          titleLabel: 'Title',
          titlePlaceholder: 'Required',
          authorLabel: 'Author',
        ...
        ebook: {
          ...
          readFailed: 'Failed to read ebook file',
          idle: 'Batch import · EPUB/AZW3/MOBI · 80MB per book · Up to {{count}} books',
          invalidFile: 'Choose an EPUB, AZW3, or MOBI file',
          oversize: 'Ebook files cannot exceed 80MB',
          entryTooLarge: 'The ebook contains oversized decompressed content and cannot be imported',
          noReadableChapters: 'This ebook has no readable chapters',
          ...
          tooManyFiles: 'Import up to {{count}} ebooks at once',
          duplicate: 'This ebook is already in the library',
          errorFallback: 'Failed to add ebook',
          idleDropTitle: 'Drop ebook files, or click to choose',
    ...
    sedimentation: {
      ...
      organizeConfirmTitle: 'Organize this discussion?',
      organizeConfirmDescription:
        'The review assistant will turn the highlight, thoughts, and review discussion into additions you can add manually; it will not rewrite the draft.',
      organizeConfirmCancel: 'Not now',
      organizeConfirmSubmit: 'Start organizing',
      organizeCardTitle: 'Discussion organization',
      organizeCardRunning: 'Organizing discussion...',
      organizeCardDone: 'Organization complete',
      organizeCardDoneWithProposals: 'Organization complete · {{count}} draft additions',
      organizeCardDoneWithFindings: 'Organization complete · {{count}} findings',
      organizeCardFailed: 'Organization failed',
      organizeCardEmpty: 'No organized output yet',
      organizeCardRetry: 'Retry',
      organizeCardClose: 'Close organization result',
      organizeAppendProposal: 'Add to draft',
      organizeAddedToDraft: 'Added to draft',
      organizeDuplicateDraft: 'This content is already in the draft',
      organizeUnsupportedProposal: 'This suggestion cannot be added directly to the draft',
    ...
    settings: {
      ...
      data: {
        ...
        toast: {
          logClearedTitle: 'Log file cleared',
          logClearedDescription: 'The current log file is now empty.',
          clearLogFailedTitle: 'Log file was not cleared',
          backupDoneTitle: 'Database backup complete',
          backupDoneDescription: 'Saved to {{path}}',
          backupCanceledTitle: 'Database backup canceled',
          backupCanceledDescription: 'No backup file was created.',
          backupFailedTitle: 'Database backup failed',
          restoreDoneTitle: 'Database restored',
          restoreDoneDescription: 'Previous database backed up to {{path}}',
          restoreCanceledTitle: 'Database restore canceled',
          restoreCanceledDescription: 'The current database was not changed.',
          restoreFailedTitle: 'Database restore failed',
        },
      ...
      models: {
        localMemory: {
          ...
          projection: 'Reading assets',
          semantic: 'Semantic index',
          projectionCoverage: '{{count}} / {{total}} assets prepared',
          semanticCoverage: '{{count}} / {{total}} memories indexed',
          modelVersion: 'Index model version',
          queryModelVersion: 'Current search version',
          download: 'Download model',
          resumeDownload: 'Resume download',
          cancelDownload: 'Cancel download',
          remove: 'Delete model and index',
          ...
          loadFailed: 'Unable to read local model status. Please retry.',
          actionFailed: 'The action did not complete. Please retry.',
          downloadProgress: 'Downloaded {{downloaded}} / {{total}}',
          retainedProgress: '{{bytes}} retained. You can resume the download.',
          byteSize: '{{size}} ({{bytes}} bytes)',
          removeTitle: 'Delete the local model and index?',
          removeDescription:
            'Only downloaded model files and the generated semantic index will be deleted. Annotations, comments, distillations, and source content will remain. You can download the model and build the index again later.',
          lifecycle: {
            checking: 'Checking',
          ...
          failure: {
            integrity: 'Model verification failed. Please download it again.',
            network: 'The download failed. Check your connection and retry.',
            storage: 'Unable to save model files. Check free space and folder permissions.',
            timeout: 'The model download timed out. Please retry.',
            'unsupported-platform': 'This local model is not yet supported on your system.',
          },
        },
        trailRoot: 'Settings',
        ...
        editorKicker: 'Settings · Model service',
        editorDescription: 'Manage model providers, API keys, Base URL, and available models.',
        chooseProviderDescription:
          'Choose a protocol provider first, then complete the connection settings.',
        connectionDescription: 'Confirm the connection settings, choose a model, test, then save.',
        closeProviderEditor: 'Close provider configuration',
        providerStepsAria: 'Provider configuration steps',
        chooseProviderStep: 'Choose provider',
        connectionStep: 'Connection settings',
        searchProvider: 'Search providers',
        presetModelCount: '{{count}} preset models',
        noMatchedProvider: 'No matching providers',
        ...
        noModelsYet: 'No models yet. Add a custom model or fetch the model list',
        noMatchedModelWithQuery: 'No models match “{{query}}”',
        customModelName: 'Custom model name',
        useCustomModel: 'Use',
        updateCustomModel: 'Update',
        cancelCustomModelEdit: 'Cancel edit',
        presetModelTag: 'Preset',
        customModelTag: 'Custom',
        hidePresetModel: 'Hide preset model {{model}}',
        hiddenPresetModels: 'Hidden preset models',
        editCustomModel: 'Edit custom model {{model}}',
        deleteCustomModel: 'Delete custom model {{model}}',
