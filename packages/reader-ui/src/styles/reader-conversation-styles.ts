...
.reader-app{--app-viewport-height:100vh;--reader-z-toolbar:var(--app-z-dropdown,140);--reader-z-popover:var(--app-z-popover,160);--reader-z-panel:var(--app-z-panel,190);--reader-z-modal:var(--app-z-modal,320);--reader-z-tooltip:var(--app-z-tooltip,340);--dropdown-open-dur:190ms;--dropdown-close-dur:120ms;--dropdown-pre-scale:.97;--dropdown-closing-scale:.99;--dropdown-ease:cubic-bezier(.22,1,.36,1);--reader-ink-weak:color-mix(in srgb,var(--reader-ink) 34%,transparent);--reader-ink-subtle:color-mix(in srgb,var(--reader-ink) 12%,transparent);--reader-ink-hairline:color-mix(in srgb,var(--reader-ink) 8%,transparent);--reader-paper-hover:color-mix(in srgb,var(--reader-ink) 6%,var(--reader-paper));--reader-paper-panel:color-mix(in srgb,var(--app-reader-note-bg) 74%,var(--reader-paper));--reader-focus-ring:var(--app-interactive-focus-ring,color-mix(in srgb,var(--reader-ink) 42%,transparent));--reader-code-bg:color-mix(in srgb,var(--reader-ink) 92%,var(--reader-paper));--reader-code-fg:var(--reader-paper);--reader-review-support-fg:var(--app-interactive-success-fg,#356f51);--reader-review-support-bg:var(--app-interactive-success-bg,color-mix(in srgb,var(--reader-review-support-fg) 12%,transparent));--reader-review-support-border:color-mix(in srgb,var(--reader-review-support-fg) 22%,transparent);--reader-review-challenge-fg:var(--reader-red,var(--app-reader-danger,#8a3f32));--reader-review-challenge-bg:color-mix(in srgb,var(--reader-review-challenge-fg) 11%,transparent);--reader-review-challenge-border:color-mix(in srgb,var(--reader-review-challenge-fg) 22%,transparent);--reader-review-supplement-fg:#3f6d8b;--reader-review-supplement-bg:color-mix(in srgb,var(--reader-review-supplement-fg) 11%,transparent);--reader-review-supplement-border:color-mix(in srgb,var(--reader-review-supplement-fg) 22%,transparent);--reader-focus-card-hover-bg:var(--reader-paper-hover);--reader-focus-card-icon-bg:var(--reader-ink-hairline);--reader-focus-card-icon-fg:var(--reader-muted);--reader-focus-card-active-icon-fg:var(--reader-paper);--reader-search-highlight:color-mix(in srgb,var(--reader-green) 20%,transparent);--reader-search-highlight-active:color-mix(in srgb,var(--reader-green) 34%,transparent);--reader-elevated-shadow:0 18px 48px color-mix(in srgb,var(--reader-ink) 16%,transparent);--reader-soft-shadow:0 8px 20px color-mix(in srgb,var(--reader-ink) 6%,transparent)}
@supports (height:100dvh){.reader-app{--app-viewport-height:100dvh}}
.reader-app{--clear-dur:1000ms;--clear-out-dur:400ms;--clear-in-dur:400ms;--clear-out-fly:12px;--clear-in-fly:12px;--clear-out-ease:cubic-bezier(.22,1,.36,1);--clear-in-ease:cubic-bezier(.22,1,.36,1);--clear-blur:2px;--glow-delay:50ms;--glow-peak-at:.15;--glow-opacity:.42;--glow-spread:1.5}
.reader-app.is-reader-background-dark{--glow-opacity:.85;--reader-focus-ring:color-mix(in srgb,var(--reader-paper) 18%,var(--reader-ink));--reader-code-bg:color-mix(in srgb,var(--reader-paper) 84%,var(--reader-ink));--reader-code-fg:var(--reader-ink);--reader-review-supplement-fg:#8fc4df;--reader-focus-card-hover-bg:color-mix(in srgb,var(--reader-ink) 8%,var(--reader-paper));--reader-focus-card-icon-bg:color-mix(in srgb,var(--reader-ink) 9%,var(--reader-paper));--reader-focus-card-active-icon-fg:var(--reader-paper)}
.t-clear{position:relative;overflow:hidden}
.t-clear-mirror,.t-clear-placeholder{position:absolute;inset:0;display:flex;align-items:center;pointer-events:none;white-space:nowrap;overflow:hidden;z-index:2}
.t-clear-mirror{opacity:0}.t-clear.has-value .t-clear-mirror,.t-clear.is-clearing .t-clear-mirror{opacity:1}
.t-clear.has-value>input,.t-clear.is-clearing>input{-webkit-text-fill-color:transparent}
.t-clear.has-value .t-clear-placeholder{opacity:0}
.t-clear-glow{position:absolute;inset:0;pointer-events:none;opacity:0;z-index:3;mix-blend-mode:multiply}
.reader-app.is-reader-background-dark .t-clear-glow{mix-blend-mode:screen}
...
.t-dropdown{transform-origin:var(--transform-origin,var(--popup-transform-origin,top left));transform:scale(var(--dropdown-pre-scale));opacity:0;pointer-events:none;transition:transform var(--dropdown-open-dur) var(--dropdown-ease),opacity var(--dropdown-open-dur) var(--dropdown-ease);will-change:transform,opacity}
.t-dropdown[data-side="bottom"]{--popup-transform-origin:top center}.t-dropdown[data-side="bottom"][data-align="start"]{--popup-transform-origin:top left}.t-dropdown[data-side="bottom"][data-align="end"]{--popup-transform-origin:top right}.t-dropdown[data-side="top"]{--popup-transform-origin:bottom center}.t-dropdown[data-side="top"][data-align="start"]{--popup-transform-origin:bottom left}.t-dropdown[data-side="top"][data-align="end"]{--popup-transform-origin:bottom right}.t-dropdown[data-side="right"],.t-dropdown[data-side="inline-end"]{--popup-transform-origin:left center}.t-dropdown[data-side="right"][data-align="start"],.t-dropdown[data-side="inline-end"][data-align="start"]{--popup-transform-origin:left top}.t-dropdown[data-side="right"][data-align="end"],.t-dropdown[data-side="inline-end"][data-align="end"]{--popup-transform-origin:left bottom}.t-dropdown[data-side="left"],.t-dropdown[data-side="inline-start"]{--popup-transform-origin:right center}.t-dropdown[data-side="left"][data-align="start"],.t-dropdown[data-side="inline-start"][data-align="start"]{--popup-transform-origin:right top}.t-dropdown[data-side="left"][data-align="end"],.t-dropdown[data-side="inline-start"][data-align="end"]{--popup-transform-origin:right bottom}.t-dropdown[data-side="none"]{--popup-transform-origin:center}
.t-dropdown[data-open],.t-dropdown.is-open{transform:scale(1);opacity:1;pointer-events:auto}.t-dropdown[data-starting-style]{transform:scale(var(--dropdown-pre-scale));opacity:0}.t-dropdown[data-closed],.t-dropdown[data-ending-style],.t-dropdown.is-closing{transform:scale(var(--dropdown-closing-scale));opacity:0;pointer-events:none;transition:transform var(--dropdown-close-dur) var(--dropdown-ease),opacity var(--dropdown-close-dur) var(--dropdown-ease)}
...
.reader-search-input-shell{--reader-search-clear-pad:26px;display:block;flex:1 1 auto;min-width:0;height:30px;color:var(--reader-ink)}
.reader-search-box input{position:relative;z-index:1;width:100%;min-width:0;height:100%;border:0;border-radius:0;background:transparent;box-shadow:none;color:var(--reader-ink);font:inherit;font-size:12px;font-weight:760;line-height:1;outline:0;padding:0 var(--reader-search-clear-pad) 0 0;appearance:none;-webkit-appearance:none}
...
.reader-search-input-shell input::placeholder{color:transparent}
.reader-search-input-shell .t-clear-mirror,.reader-search-input-shell .t-clear-placeholder{inset:0 var(--reader-search-clear-pad) 0 0;color:var(--reader-ink);font:inherit;font-size:12px;font-weight:760;line-height:1}
.reader-search-input-shell .t-clear-placeholder{color:var(--reader-muted)}
.reader-search-clear-button{position:absolute;right:0;top:3px;z-index:4;display:grid;width:24px;height:24px;place-items:center;border:0;border-radius:6px;background:transparent;color:var(--reader-muted);opacity:1;padding:0;transition:color .14s ease,opacity .14s ease,transform .14s ease}
.reader-search-clear-button:hover:not(:disabled){color:var(--reader-ink)}
.reader-search-clear-button:active:not(:disabled){transform:scale(.92)}
.reader-search-clear-button:disabled{opacity:0;pointer-events:none}
@media (prefers-reduced-motion:reduce){.t-clear-glow{opacity:0!important}.t-clear-mirror,.t-clear-placeholder{filter:none!important;transform:none!important}.reader-search-clear-button{transition:none}}
...
.reader-chat-fab.is-returning{animation:reader-chat-fab-return var(--reader-chat-fab-return-dur) cubic-bezier(.22,1,.36,1) both}
...
.reader-chat-panel{position:fixed;right:22px;bottom:22px;z-index:var(--reader-z-panel);--reader-chat-morph-closed-size:46px;--reader-chat-morph-closed-radius:14px;--reader-chat-morph-open-radius:18px;--reader-chat-morph-open-dur:350ms;--reader-chat-morph-close-dur:250ms;--reader-chat-morph-fade-dur:200ms;--reader-chat-morph-ease:cubic-bezier(.34,1.25,.64,1);--reader-chat-morph-close-ease:cubic-bezier(.22,1,.36,1);--reader-chat-morph-slide:40px;--reader-chat-morph-scale:.97;--reader-chat-morph-blur:2px;display:grid;grid-template-rows:auto minmax(0,1fr) auto;width:var(--reader-chat-panel-width,min(410px,calc(100vw - 32px)));height:var(--reader-chat-panel-height,min(640px,calc(var(--app-viewport-height) - 112px)));max-width:calc(100vw - 32px);max-height:calc(var(--app-viewport-height) - 112px);overflow:hidden;border:1px solid var(--app-reader-chat-panel-border);border-radius:var(--reader-chat-morph-open-radius);background:var(--app-reader-chat-panel-bg);box-shadow:var(--app-reader-chat-panel-shadow);font-family:var(--font-ui, ui-sans-serif, system-ui, sans-serif);color:var(--reader-ink);opacity:1;filter:blur(0);transform:scale(var(--reader-chat-resize-scale-x,1),var(--reader-chat-resize-scale-y,1));transform-origin:100% 100%;transition:width var(--reader-chat-morph-open-dur) var(--reader-chat-morph-ease),height var(--reader-chat-morph-open-dur) var(--reader-chat-morph-ease),border-radius var(--reader-chat-morph-open-dur) var(--reader-chat-morph-ease),transform 160ms var(--reader-chat-morph-close-ease),box-shadow 160ms ease}
.reader-chat-panel.is-opening,.reader-chat-panel.is-closing{width:var(--reader-chat-morph-closed-size);height:var(--reader-chat-morph-closed-size);border-radius:var(--reader-chat-morph-closed-radius);pointer-events:none}
.reader-chat-panel.is-closing{z-index:calc(var(--reader-z-popover) - 1);transition:width var(--reader-chat-morph-close-dur) var(--reader-chat-morph-close-ease),height var(--reader-chat-morph-close-dur) var(--reader-chat-morph-close-ease),border-radius var(--reader-chat-morph-close-dur) var(--reader-chat-morph-close-ease),transform 120ms var(--reader-chat-morph-close-ease),box-shadow 120ms ease}
.reader-chat-panel>.reader-chat-header,.reader-chat-panel>.reader-chat-messages,.reader-chat-panel>.reader-chat-composer{opacity:1;filter:blur(0);transform:translateX(0) scale(1);transition:opacity var(--reader-chat-morph-fade-dur) var(--reader-chat-morph-close-ease),filter var(--reader-chat-morph-fade-dur) var(--reader-chat-morph-close-ease),transform var(--reader-chat-morph-open-dur) var(--reader-chat-morph-close-ease)}
.reader-chat-panel.is-opening>.reader-chat-header,.reader-chat-panel.is-opening>.reader-chat-messages,.reader-chat-panel.is-opening>.reader-chat-composer,.reader-chat-panel.is-closing>.reader-chat-header,.reader-chat-panel.is-closing>.reader-chat-messages,.reader-chat-panel.is-closing>.reader-chat-composer{opacity:0;filter:blur(var(--reader-chat-morph-blur));transform:translateX(var(--reader-chat-morph-slide)) scale(var(--reader-chat-morph-scale));pointer-events:none}
.reader-chat-panel.is-opening>.reader-chat-resize-handle,.reader-chat-panel.is-closing>.reader-chat-resize-handle{opacity:0;pointer-events:none}
...
@keyframes reader-chat-fab-return{0%{transform:scale(.92,1.08)}46%{transform:scale(1.08,.94)}72%{transform:scale(.98,1.03)}100%{transform:scale(1)}}
@media (prefers-reduced-motion:reduce){.reader-chat-fab.is-returning{animation:none!important;transform:none!important}.reader-chat-panel,.reader-chat-panel>.reader-chat-header,.reader-chat-panel>.reader-chat-messages,.reader-chat-panel>.reader-chat-composer{filter:none!important;transform:none!important;transition:none!important}}
...
.reader-agent-option:hover .reader-agent-select b{background:var(--reader-ink);color:var(--reader-paper)}
.reader-agent-option.is-running .reader-agent-select b{background:rgba(159,91,80,.1);color:var(--reader-red)}
.reader-agent-option.is-selected .reader-agent-select b{background:var(--reader-ink);color:var(--reader-paper)}
...
.reader-agent-annotate-menu .reader-plan-action:hover::after{content:attr(data-description);position:absolute;left:50%;bottom:calc(100% + 9px);z-index:4;width:max-content;max-width:240px;transform:translateX(-50%);border-radius:10px;background:var(--reader-ink);color:var(--reader-paper);box-shadow:0 12px 28px color-mix(in srgb,var(--reader-ink) 20%,transparent);font-size:11px;font-weight:760;line-height:1.45;padding:8px 10px;white-space:normal}
...
.reader-agent-annotate-menu .reader-focus-plan:hover:not(:disabled){background:color-mix(in srgb,var(--reader-ink) 88%,var(--reader-paper));box-shadow:0 8px 18px color-mix(in srgb,var(--reader-ink) 16%,transparent)}
...
.reader-focus-progress>i>b{display:block;height:100%;border-radius:inherit;background:linear-gradient(90deg,var(--reader-ink),var(--reader-review-challenge-fg),var(--reader-yellow-strong));transition:width .34s cubic-bezier(.22,1,.36,1)}
...
.reader-focus-card-summary>b{display:grid;width:32px;height:32px;place-items:center;border-radius:999px;background:var(--reader-focus-card-icon-bg);color:var(--reader-focus-card-icon-fg);font-size:12px;font-weight:950}
.reader-focus-section-card.is-open .reader-focus-card-summary>b{background:var(--reader-ink);color:var(--reader-focus-card-active-icon-fg)}
...
.reader-review-label.is-challenge{border-color:var(--reader-review-challenge-border);background:var(--reader-review-challenge-bg);color:var(--reader-review-challenge-fg)}
...
.reader-toc-item-main{display:grid;grid-template-columns:minmax(0,1fr) auto;align-items:center;gap:10px;min-width:0;box-sizing:border-box;padding-right:var(--reader-toc-title-shift,0px);transform:translateX(var(--reader-toc-title-shift,0px));transition:padding-right var(--reader-toc-motion),transform var(--reader-toc-motion);will-change:transform}
.reader-toc-label{overflow:hidden;text-overflow:ellipsis;white-space:nowrap}
.reader-toc-item{position:relative;overflow:hidden;transform:translateX(var(--reader-toc-shift,0px));transition:background .16s ease,color .16s ease,transform var(--reader-toc-motion);will-change:transform}
.reader-toc-item:hover,.reader-toc-item.is-active{--reader-toc-line-current-width:var(--reader-toc-line-active-width);--reader-toc-title-shift:var(--reader-toc-line-active-delta)}
.reader-toc-line{display:block;width:var(--reader-toc-line-current-width);height:1px;border-radius:999px;background:color-mix(in srgb,var(--reader-ink) 22%,transparent);transform-origin:left center;transition:width var(--reader-toc-motion),background .16s ease;will-change:width}
...
.reader-note-tabs [data-slot="tabs-trigger"]:focus-visible{outline:2px solid var(--reader-focus-ring);outline-offset:2px}
...
.reader-note.has-discussion .reader-note-body,.reader-note.has-distillation .reader-note-body{position:relative;min-width:0;overflow:visible;border-radius:10px 0 10px 0;background:var(--reader-note-surface);box-shadow:0 2px 5px color-mix(in srgb,var(--reader-ink) 7%,transparent)}
...
.reader-action-menu-button:focus-visible{outline:2px solid var(--reader-focus-ring);outline-offset:2px}
...
.reader-note.is-dual-stamp-in .reader-note-dual-face-distillation::after{content:"";position:absolute;inset:0;z-index:6;border-radius:14px 0 14px 0;background:linear-gradient(105deg,transparent 42%,color-mix(in srgb,var(--reader-note-surface,var(--reader-paper)) 60%,transparent) 50%,transparent 58%);pointer-events:none;animation:reader-distillation-shimmer .6s cubic-bezier(.22,1,.36,1) .12s both}
.reader-note-dual-face-annotation .reader-note-tab{border:1px solid var(--app-reader-note-annotation-border);border-bottom:0;background:var(--reader-note-surface);color:color-mix(in srgb,var(--reader-note-accent) 76%,var(--reader-ink))}
...
.reader-note-dual-face-annotation .reader-note-body,.reader-note-dual-face-distillation .reader-note-body{position:relative;min-width:0;overflow:visible;border-radius:10px 0 10px 0;background:var(--reader-note-surface);box-shadow:0 2px 5px color-mix(in srgb,var(--reader-ink) 7%,transparent)}
...
.reader-thought-summary:focus-visible{outline:2px solid var(--reader-focus-ring);outline-offset:-2px}
...
.reader-inline-composer-trigger:focus-visible{outline:2px solid var(--reader-focus-ring);outline-offset:2px}
...
.reader-highlight:focus-visible::before{opacity:1;filter:drop-shadow(0 1px 0 var(--reader-paper)) drop-shadow(0 0 6px var(--reader-focus-ring))}
