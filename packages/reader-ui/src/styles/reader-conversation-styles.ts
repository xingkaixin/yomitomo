...
.reader-note.has-discussion .reader-note-body{padding:18px 19px 15px}
...
.reader-note-discussion-summary{display:grid;flex:1 1 auto;min-width:0;min-height:40px;align-content:center;gap:3px;padding:0;color:var(--reader-muted);font-family:var(--font-ui, ui-sans-serif, system-ui, sans-serif)}
...
.reader-note-discussion-entry{display:inline-flex;flex:0 0 auto;min-width:104px;min-height:40px;align-items:center;justify-content:center;gap:6px;margin:0 -3px 0 auto;border:0;border-radius:8px;background:transparent;color:var(--reader-green);font:inherit;font-family:var(--font-ui, ui-sans-serif, system-ui, sans-serif);font-size:12px;font-weight:840;padding:0 3px 0 10px;transition:background-color .14s ease,color .14s ease,transform .14s ease}
...
.reader-note-meta{position:relative;z-index:1;display:flex;min-width:0;align-items:center;gap:8px;margin-top:15px;color:var(--reader-muted);font-family:var(--font-ui, ui-sans-serif, system-ui, sans-serif)}
...
.reader-note-me-badge{display:inline-flex;align-items:center;border-radius:6px;background:color-mix(in srgb,var(--reader-avatar-color,var(--reader-note-accent)) 16%,transparent);color:color-mix(in srgb,var(--reader-avatar-color,var(--reader-note-accent)) 80%,var(--reader-ink));font-family:var(--font-ui, ui-sans-serif, system-ui, sans-serif);font-size:10px;font-weight:800;line-height:1;padding:2px 6px;white-space:nowrap}
...
.reader-note.is-distillation-morph-out[data-distillation-transition="publish"] .reader-note-body,.reader-note.is-distillation-morph-out[data-distillation-transition="publish"] .reader-note-tab{transform-origin:center center;will-change:transform,opacity;animation:reader-annotation-stamp-out 200ms cubic-bezier(.22,1,.36,1) both}
...
@keyframes reader-distillation-cloud-recede{0%{clip-path:circle(170% at 58px -1px);opacity:1;filter:blur(0)}58%{clip-path:circle(92% at 58px -1px);opacity:.98;filter:blur(.15px)}100%{clip-path:circle(0% at 58px -1px);opacity:.68;filter:blur(4px)}}
...
@media (prefers-reduced-motion: reduce){.reader-note.is-distillation-morph-out,.reader-note.is-distillation-morph-out .reader-note-body,.reader-note.is-distillation-morph-out .reader-note-tab,.reader-note.is-distillation-morph-in .reader-note-body,.reader-note.is-distillation-morph-in .reader-note-tab,.reader-note.is-distillation-morph-in .reader-note-distillation-footer,.reader-note.is-distillation-update .reader-note-body,.reader-note.is-distillation-update .reader-note-quote-text,.reader-note.is-distillation-morph-in::after,.reader-note.is-distillation-update::after,.reader-note-unpublish-overlay{animation:none;clip-path:none;filter:none;will-change:auto}}
...
.reader-note-unpublish-overlay{position:absolute;inset:0;z-index:8;overflow:visible;padding:11px 11px 0;border:1px solid var(--app-reader-note-distillation-border);border-radius:14px 0 14px 0;background:var(--app-reader-note-distillation-mat);box-shadow:var(--app-reader-note-shadow);pointer-events:none;--reader-note-accent:var(--app-reader-note-distillation-accent);--reader-note-border:var(--app-reader-note-distillation-border);will-change:clip-path,filter,opacity;animation:reader-distillation-cloud-recede 620ms cubic-bezier(.22,1,.36,1) both}
.reader-note.has-discussion .reader-note-unpublish-overlay .reader-note-tab{top:-14px;border:1px solid var(--reader-note-accent);background:var(--reader-note-accent);color:var(--app-reader-note-distillation-tab-fg)}
.reader-note.has-discussion .reader-note-unpublish-overlay .reader-note-tab::after{content:none}
.reader-note.has-discussion .reader-note-unpublish-overlay .reader-note-body{display:block;padding:22px 22px 18px;border-radius:10px 0 10px 0;background:var(--reader-paper);box-shadow:0 2px 5px color-mix(in srgb,var(--reader-ink) 7%,transparent)}
.reader-note-unpublish-overlay .reader-note-quote{align-items:center;padding-right:22px}
.reader-note-unpublish-overlay .reader-note-quote-text{font-size:15px;font-weight:600;letter-spacing:0;line-height:1.75}
.reader-note-unpublish-overlay .reader-note-distillation-footer{justify-content:flex-end;margin:0;padding:4px 12px 7px;background:transparent}
