...
@keyframes reader-annotation-stamp-out{0%{transform:translateY(0) scale(1);opacity:1}100%{transform:translateY(-5px) scale(.97);opacity:0}}
@keyframes reader-distillation-settle-in{0%{transform:translateY(4px) scale(.985);opacity:0;filter:blur(2px)}100%{transform:translateY(0) scale(1);opacity:1;filter:blur(0)}}
...
@keyframes reader-distillation-reveal-in{0%{clip-path:circle(0% at 58px -1px)}100%{clip-path:circle(170% at 58px -1px)}}
