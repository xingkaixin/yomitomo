...
.reader-note.is-distillation-morph-in[data-distillation-transition="unpublish"] .reader-note-body,.reader-note.is-distillation-morph-in[data-distillation-transition="unpublish"] .reader-note-tab{transform-origin:16% 0%;will-change:opacity,filter;animation:reader-annotation-reveal-in 180ms ease-out both}
...
@keyframes reader-distillation-reveal-contract{0%{clip-path:circle(160% at 13% 0%);opacity:1}100%{clip-path:circle(0% at 13% 0%);opacity:1}}
@keyframes reader-annotation-reveal-in{0%{opacity:0;filter:blur(4px)}100%{opacity:1;filter:blur(0)}}
