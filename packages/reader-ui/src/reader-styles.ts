...
.reader-note{scroll-margin-top:86px;border:1px solid rgba(40,35,29,.1);border-radius:18px;padding:14px;background:rgba(255,253,248,.96);box-shadow:0 4px 24px rgba(40,35,29,.12)}
...
.reader-selection-menu{display:inline-flex;align-items:center;gap:5px;width:max-content;border:1px solid rgba(40,35,29,.12);border-radius:999px;background:rgba(255,255,255,.98);box-shadow:0 18px 48px rgba(40,35,29,.14),0 2px 8px rgba(40,35,29,.06);backdrop-filter:blur(18px);padding:6px;font-family:var(--font-ui, ui-sans-serif, system-ui, sans-serif)}
.reader-selection-menu>button{justify-content:flex-start;color:var(--reader-ink);gap:6px}
.reader-selection-primary{height:36px;border:1px solid rgba(37,29,22,.09);background:#fff;box-shadow:0 3px 10px rgba(55,42,24,.05);font-size:13px}
...
.reader-highlight-choice-menu{position:absolute;z-index:160;width:240px;display:grid;gap:6px;padding:10px;border:1px solid rgba(40,35,29,.14);border-radius:16px;background:rgba(255,253,248,.97);box-shadow:0 18px 48px rgba(40,35,29,.16);font-family:var(--font-ui, ui-sans-serif, system-ui, sans-serif)}
...
.reader-agent-annotate-menu .reader-focus-agent-chip,.reader-agent-annotate-menu .reader-focus-assigned-chip{display:inline-flex;width:auto;height:34px;grid-template-columns:none;align-items:center;justify-content:center;gap:7px;border:1px solid rgba(40,35,29,.1);border-radius:999px;background:#fff;color:var(--reader-ink);cursor:pointer;font:inherit;font-size:12px;font-weight:860;padding:0 10px 0 4px;transition:background .14s ease,border-color .14s ease,box-shadow .14s ease,transform .14s ease}
...
.reader-agent-annotate-menu .reader-focus-add{display:inline-flex;width:auto;height:34px;grid-template-columns:none;align-items:center;justify-content:center;gap:7px;border:1px dashed rgba(40,35,29,.24);border-radius:999px;background:#fff;color:var(--reader-ink);cursor:pointer;font:inherit;font-size:12px;font-weight:860;padding:0 12px;white-space:nowrap;transition:background .14s ease,border-color .14s ease,box-shadow .14s ease,transform .14s ease}
...
.reader-focus-add-menu{position:absolute;left:0;top:calc(100% + 8px);z-index:8;display:grid;gap:4px;width:220px;max-height:260px;overflow:auto;padding:8px;border:1px solid rgba(40,35,29,.12);border-radius:14px;background:#fff;box-shadow:0 18px 44px rgba(40,35,29,.16)}
...
.reader-agent-annotate-menu .reader-focus-clear{display:inline-flex;width:auto;height:38px;grid-template-columns:none;align-items:center;justify-content:center;gap:6px;border:1px solid rgba(40,35,29,.12);border-radius:999px;background:#fff;color:var(--reader-muted);cursor:pointer;font:inherit;font-size:12px;font-weight:860;padding:0 12px;white-space:nowrap;transition:background .14s ease,border-color .14s ease,color .14s ease,transform .14s ease}
...
.reader-agent-annotate-menu .reader-focus-plan{display:inline-flex;width:auto;height:38px;grid-template-columns:none;align-items:center;justify-content:center;gap:7px;border:0;border-radius:999px;background:var(--reader-ink);color:#fff;cursor:pointer;font:inherit;font-size:12px;font-weight:900;padding:0 14px;white-space:nowrap;transition:background .14s ease,box-shadow .14s ease,transform .14s ease}
...
.reader-agent-avatar-stack-item{position:relative;display:grid;flex:0 0 auto;width:28px;min-width:28px;max-width:28px;height:28px;place-items:center;margin-left:-8px;appearance:none;border:2px solid #fff;border-radius:999px;background:#fff;box-shadow:0 2px 7px rgba(40,35,29,.12);color:inherit;line-height:1;padding:0;overflow:visible;transition:transform .16s cubic-bezier(.22,1,.36,1),box-shadow .16s ease,z-index .16s ease}
.reader-agent-avatar-stack-item:first-child{margin-left:0}
.reader-agent-avatar-stack-item:hover,.reader-agent-avatar-stack-item:focus-visible,.reader-agent-avatar-stack-item.is-revealed{z-index:2;box-shadow:0 8px 18px rgba(40,35,29,.16);transform:translateY(-4px) scale(1.12)}
...
.reader-agent-avatar-stack-label{position:absolute;left:50%;bottom:calc(100% + 8px);z-index:3;display:block;max-width:132px;overflow:hidden;transform:translateX(-50%);border:1px solid rgba(40,35,29,.12);border-radius:10px;background:#fff;box-shadow:0 12px 28px rgba(40,35,29,.14);color:var(--reader-ink);font-family:var(--font-ui, ui-sans-serif, system-ui, sans-serif);font-size:11px;font-weight:850;line-height:1.25;padding:7px 8px;text-align:center;text-overflow:ellipsis;white-space:nowrap}
...
.reader-agent-annotate-menu .reader-focus-message-footer>button{display:inline-flex;width:auto;height:40px;grid-template-columns:none;align-items:center;justify-content:center;gap:7px;border:0;border-radius:999px;background:#e8e8e6;color:var(--reader-ink);cursor:pointer;font:inherit;font-size:12px;font-weight:850;padding:0 13px;white-space:nowrap}
...
.reader-agent-annotate-menu .reader-focus-message-agents .reader-agent-avatar-stack-item{width:30px;height:30px;border-color:#fff;background:#fff}
.reader-agent-annotate-menu .reader-focus-message-agents .reader-agent-avatar-stack-item:hover{background:#fff}
.reader-focus-message-agents .reader-avatar-badge{width:26px;height:26px}
.reader-focus-agent-menu{right:auto;bottom:calc(100% + 8px);z-index:24;width:176px;max-width:min(176px,calc(100% - 16px));border-color:rgba(40,35,29,.16);background:#fff;box-shadow:0 18px 44px rgba(40,35,29,.18),0 3px 10px rgba(40,35,29,.08)}
...
.reader-markdown{min-width:0;color:#3f352c;font-family:var(--font-ui, ui-sans-serif, system-ui, sans-serif);font-size:13px;line-height:1.66;overflow-wrap:anywhere;word-break:break-word}
...
.reader-note-tabs [data-slot="tabs-trigger"]{height:30px;border:0;border-radius:999px;background:transparent;color:var(--reader-muted);cursor:pointer;font-family:var(--font-ui, ui-sans-serif, system-ui, sans-serif);font-size:12px;font-weight:850;letter-spacing:0;padding:0 8px}
...
.reader-review-invite{display:inline-flex;min-width:78px;align-items:center;justify-content:center;gap:5px;border:0;background:#fff;color:var(--reader-muted);cursor:pointer;font:inherit;font-family:var(--font-ui, ui-sans-serif, system-ui, sans-serif);font-size:11px;font-weight:860;padding:0 11px;transition:background .14s ease,color .14s ease}
...
.reader-review-menu{position:absolute;right:8px;bottom:calc(100% + 8px);z-index:30;display:grid;gap:4px;width:238px;padding:8px;border:1px solid rgba(40,35,29,.12);border-radius:14px;background:#fffdf8;box-shadow:0 16px 42px rgba(40,35,29,.16);font-family:var(--font-ui, ui-sans-serif, system-ui, sans-serif);transform-origin:bottom right}
...
.reader-action-menu-button{display:grid;width:32px;height:32px;place-items:center;border:0;border-radius:999px;background:transparent;color:var(--reader-muted);cursor:pointer;padding:0;transition:background .14s ease,color .14s ease,transform .14s ease}
...
.reader-action-menu-panel{position:absolute;right:0;top:calc(100% + 7px);z-index:36;display:grid;min-width:132px;padding:4px;border:1px solid rgba(40,35,29,.12);border-radius:10px;background:#fff;box-shadow:0 10px 24px rgba(40,35,29,.12);font-family:var(--font-ui, ui-sans-serif, system-ui, sans-serif);transform-origin:top right}
...
.reader-note-meta time{flex:0 0 auto;color:#8d8378;font-size:11px;font-weight:760;font-variant-numeric:tabular-nums;white-space:nowrap}
...
.reader-note-quote{display:grid;width:100%;gap:5px;padding:0;border:0;background:transparent;color:var(--reader-ink);cursor:pointer;font-family:var(--font-reader-serif, Charter, Georgia, Cambria, "Times New Roman", serif);text-align:left;text-decoration:none}
...
.reader-thought-author-more{display:grid;min-width:25px;height:25px;place-items:center;margin-left:-8px;border:2px solid rgba(255,253,248,.92);border-radius:999px;background:#eee6db;color:var(--reader-muted);font-family:var(--font-ui, ui-sans-serif, system-ui, sans-serif);font-size:10px;font-weight:900;font-variant-numeric:tabular-nums}
...
.reader-pending-agent-more{display:grid;min-width:25px;height:25px;place-items:center;margin-left:-8px;border:2px solid rgba(255,253,248,.92);border-radius:999px;background:#eee6db;color:var(--reader-muted);font-family:var(--font-ui, ui-sans-serif, system-ui, sans-serif);font-size:10px;font-weight:900;font-variant-numeric:tabular-nums}
...
.reader-note-comments-panel>header{display:flex;align-items:center;justify-content:space-between;gap:10px;padding-bottom:8px;border-bottom:1px dashed rgba(40,35,29,.14);font-family:var(--font-ui, ui-sans-serif, system-ui, sans-serif)}
...
.reader-thought-footer{position:relative;z-index:1;display:flex;min-height:44px;flex-wrap:wrap;align-items:center;justify-content:space-between;gap:8px;overflow:visible;padding:8px 14px;border-top:1px solid rgba(40,35,29,.1);background:rgba(250,246,238,.76)}
...
.reader-thread-replies .reader-comment{position:relative;padding:11px 0;border-top:1px solid rgba(40,35,29,.1);border-radius:0;background:transparent}
.reader-thread-replies .reader-comment:first-child{border-top-color:rgba(40,35,29,.08)}
...
.reader-pending-thoughts{position:relative;display:grid;grid-template-columns:auto minmax(0,1fr);align-items:center;gap:10px;margin:8px 0 0;padding:11px 12px 13px;overflow:hidden;border:1px solid rgba(40,35,29,.1);border-radius:8px;background:rgba(255,253,248,.72);box-shadow:0 1px 3px rgba(40,35,29,.04);font-family:var(--font-ui, ui-sans-serif, system-ui, sans-serif)}
...
.reader-comment-author time{color:#9a8f83;font-size:10px;font-weight:760;font-variant-numeric:tabular-nums;white-space:nowrap}
...
.reader-comment-agent-tray>button{display:grid;width:30px;height:30px;place-items:center;border:1px solid rgba(37,29,22,.12);border-radius:999px;background:#fff;color:var(--reader-muted);cursor:pointer;padding:0}
.reader-comment-agent-tray>button:hover{background:rgba(40,35,29,.06);color:var(--reader-ink)}
...
.reader-comment-agent-tray .reader-comment-mention-label{display:grid;width:30px;height:30px;place-items:center;border:1px solid rgba(37,29,22,.12);border-radius:999px;background:#fff;color:var(--reader-muted);font-size:15px;font-weight:850}
.reader-comment-agent-tray .reader-agent-avatar-stack{padding:0}
.reader-comment-agent-tray .reader-agent-avatar-stack-item{width:30px;height:30px;border-color:#fff;background:#fff}
.reader-comment-agent-tray .reader-agent-avatar-stack-item:hover{background:#fff}
...
.reader-comment-agent-more-menu{position:absolute;right:0;bottom:calc(100% + 8px);z-index:60;display:grid;gap:4px;width:190px;padding:8px;border:1px solid rgba(40,35,29,.12);border-radius:14px;background:#fffdf8;box-shadow:0 18px 46px rgba(40,35,29,.16)}
...
.reader-comment-agent-more-menu button:hover{background:rgba(40,35,29,.06)}
...
.reader-composer-header{display:grid;gap:8px;padding:12px 14px 10px;border-bottom:1px solid rgba(40,35,29,.1);border-radius:19px 19px 0 0;background:rgba(255,253,248,.94);font-family:var(--font-ui, ui-sans-serif, system-ui, sans-serif)}
...
.reader-composer-actions .reader-composer-cancel:hover{background:rgba(40,35,29,.12)}
...
.reader-composer-actions .reader-composer-agent-tray .reader-agent-avatar-stack-item{width:28px;height:28px;border-color:#fff;background:#fff;color:inherit}
.reader-composer-actions .reader-composer-agent-tray .reader-agent-avatar-stack-item:hover{background:#fff}
.reader-composer-agent-tray .reader-avatar-badge{width:24px;height:24px}
.reader-composer .reader-agent-menu,.reader-comment-box .reader-agent-menu{right:auto;bottom:calc(100% + 8px);width:190px;max-width:min(190px,calc(100% - 16px));border-color:rgba(40,35,29,.16);background:#fff;box-shadow:0 18px 44px rgba(40,35,29,.18),0 3px 10px rgba(40,35,29,.08)}
.reader-selection-menu,.reader-composer{z-index:120}
.reader-tooltip-content{z-index:240;max-width:min(260px,calc(100vw - 24px));border:1px solid rgba(255,250,240,.16);border-radius:8px;background:#28231d;box-shadow:0 12px 28px rgba(40,35,29,.2);color:#fffaf0;font-family:var(--font-ui, ui-sans-serif, system-ui, sans-serif);font-size:11px;font-weight:760;line-height:1.35;padding:7px 9px;will-change:transform,opacity}
...
.reader-tooltip-content .reader-kbd{border-color:rgba(255,250,240,.24);border-bottom-color:rgba(255,250,240,.34);background:rgba(255,250,240,.12);box-shadow:none;color:#fffaf0}
...
@container reader-surface (max-width:1220px) and (min-width:941px){.reader-surface{padding-left:28px;padding-right:28px}.reader-canvas{width:100%;margin:0}.reader-article{width:min(var(--reader-content-width),calc(100% - 300px));margin:0}}
@media(max-width:1220px) and (min-width:941px){.reader-surface{padding-left:28px;padding-right:28px}.reader-canvas{width:100%;margin:0}.reader-article{width:min(var(--reader-content-width),calc(100% - 300px));margin:0}}
...
.reader-app{color-scheme:light;--reader-bg:#f5f1e8;--reader-paper:#fffdf8;--reader-ink:#28231d;--reader-muted:#746d63;--reader-line:#e3dccf;--reader-green:#28231d;--reader-red:#9f5b50;--reader-yellow:#ead89d;--reader-yellow-strong:#c7a45e;font-family:var(--font-reader-serif, Charter, Georgia, Cambria, "Times New Roman", serif)}
