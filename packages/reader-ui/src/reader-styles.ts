...
.reader-toolbar-popover{position:absolute;left:50%;top:calc(100% + 8px);z-index:260;width:190px;padding:9px;border:1px solid var(--app-reader-toolbar-border);border-radius:8px;background:var(--app-reader-toolbar-bg);box-shadow:var(--reader-soft-shadow),inset 0 1px 0 color-mix(in srgb,var(--reader-paper) 58%,transparent);transform:translateX(-50%)}
...
.reader-chat-panel{position:fixed;right:22px;bottom:22px;z-index:190;display:grid;grid-template-rows:auto minmax(0,1fr) auto;width:min(410px,calc(100vw - 32px));max-height:min(640px,calc(100vh - 112px));overflow:hidden;border:1px solid var(--app-reader-chat-panel-border);border-radius:18px;background:var(--app-reader-chat-panel-bg);box-shadow:var(--app-reader-chat-panel-shadow);font-family:var(--font-ui, ui-sans-serif, system-ui, sans-serif);color:var(--reader-ink)}
...
.reader-highlight-choice-menu{position:absolute;z-index:160;width:240px;display:grid;gap:6px;padding:10px;border:1px solid var(--app-reader-composer-border);border-radius:16px;background:var(--reader-paper);box-shadow:var(--reader-elevated-shadow);font-family:var(--font-ui, ui-sans-serif, system-ui, sans-serif)}
...
.reader-agent-annotate-menu{gap:8px;margin:8px 0 18px;padding:14px;border-color:var(--reader-ink-subtle);border-radius:18px;background:var(--reader-paper);overflow:auto;max-height:calc(100vh - 112px)}
...
.reader-app.has-toc .reader-toc{position:absolute;display:block;left:18px;top:84px;bottom:18px;z-index:30;width:min(320px,calc(100% - 36px));overflow:auto;padding:18px;border:1px solid var(--app-reader-selection-menu-border);border-radius:8px;background:var(--app-reader-toc-bg);box-shadow:var(--reader-elevated-shadow);opacity:0;visibility:hidden;pointer-events:none;transform:translateX(-12px);transition:opacity .2s ease,transform .2s ease,visibility .2s}
...
.reader-app{color-scheme:light;--reader-bg:var(--app-reader-bg);--reader-paper:var(--app-reader-paper);--reader-ink:var(--app-reader-ink);--reader-muted:var(--app-reader-muted);--reader-line:var(--app-reader-line);--reader-green:var(--app-reader-primary);--reader-red:var(--app-reader-danger);--reader-yellow:var(--app-reader-accent);--reader-yellow-strong:var(--app-reader-accent-strong);--reader-ink-weak:color-mix(in srgb,var(--reader-ink) 34%,transparent);--reader-ink-subtle:color-mix(in srgb,var(--reader-ink) 12%,transparent);--reader-ink-hairline:color-mix(in srgb,var(--reader-ink) 8%,transparent);--reader-paper-hover:color-mix(in srgb,var(--reader-ink) 6%,var(--reader-paper));--reader-paper-panel:color-mix(in srgb,var(--app-reader-note-bg) 74%,var(--reader-paper));--reader-elevated-shadow:0 18px 48px color-mix(in srgb,var(--reader-ink) 16%,transparent);--reader-soft-shadow:0 8px 20px color-mix(in srgb,var(--reader-ink) 6%,transparent);font-family:var(--font-reader-serif, Charter, Georgia, Cambria, "Times New Roman", serif)}
