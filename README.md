...
Yomitomo 是一个本地优先的 AI 伴读桌面应用。Electron 桌面端负责网页文章与 EPUB 电子书导入、阅读库、批注、评论、LLM provider 管理和阅读助手；Astro 官网负责产品介绍、下载入口和社交预览。
...
- 桌面阅读器：目录、字号、宽度、高亮、悬浮目录、双侧笔记栏、选区快捷键和批注导航。
