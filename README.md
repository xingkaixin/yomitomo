...
Yomitomo 是一个本地优先的 AI 伴读桌面应用。Electron 桌面端负责网页文章、EPUB 电子书与 PDF 导入、阅读库、批注、评论、微信读书同步、LLM provider 管理和阅读助手；Astro 官网负责产品介绍、下载入口和社交预览。
