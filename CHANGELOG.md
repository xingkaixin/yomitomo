...
- Updated native SQLite verification and macOS preparation for `better-sqlite3` prebuilt binaries, and moved native checks into the desktop build so release packaging failures surface in PR CI. (#837)
